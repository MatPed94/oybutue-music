...
$(document).ready(function() {
  ...
  $(".playbackBar .progressBar").mousemove(function(e) {
    if (mouseDown) {
      //Set time on song, depending on position of mousedown
...
function timeFromOffset(e, progressBar) {
  var percent = e.offsetX / $(progressBar).width() * 100;
...
function setTrack(trackId, newPlaylist, play) {
  ...
  $.post("includes/handlers/ajax/getSongJson.php", { songId: trackId }, function(data){
    ...
    $.post("includes/handlers/ajax/getAlbumJson.php", { albumId: track.album }, function(data){
      ...
      $(".albumLink img").attr("alt", album.title);
      ...
      <div class="content playerControls">
        ...
        <div class="buttons">
          ...
          <button class="controlButton pause" title="Pause button" style="display: none;" onclick="pauseSong()">
            <img src="assets/images/icons/pause.png" alt="Pasue">
          </button>
        ...
        <div class="playbackBar">
          ...
          <span class="progressTime ramaining">0.00</span>
